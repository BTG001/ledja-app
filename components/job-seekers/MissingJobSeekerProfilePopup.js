...
export default function MissingJobSeekerProfilePopup({ showPopup, onClose }) {
    useEffect(() => {
        if (showPopup) {
            ...
            <>
                ...
                <div className="z-50 fixed w-4/5 md:w-2/3 lg:w-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2    top-1/2 p-10 bg-white opacity-100 rounded-10 shadow-md">
                    ...
                    <p className="text-dark-50 font-normal text-md text-center my-3 ">
                        Tip: Recruiters are more interested in <br /> candidates
                        with a full profile
                    </p>
                    ...
                    >
                        ...
                        <PrimaryBtn
                            text={"Complete Now"}
                            path="/job-seeker/profile-setup/step1"
